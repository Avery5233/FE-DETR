...
from .extra_modules.attention import HiLo, WLGH
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3):
                ...
                n = 1
        elif m in (AIFI,TransformerEncoderLayer_HiLo,WindowLow_GlobalHigh):
            args = [ch[f], *args]
        elif m in {E2MF, ConvEdgeFusion}:
            c2 = args[0]
        ...
        elif m is TransformerEncoderLayer_HiLo:
            c1, c2 = ch[f], args[0]
            c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
        elif m is WindowLow_GlobalHigh:
            c1, c2 = ch[f], args[0]
            c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
        else:

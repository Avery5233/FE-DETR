...
if __name__ == '__main__':
    model = RTDETR('ultralytics/cfg/models/rt-detr/rtdetr_C2f-FFF_AIFI-WLGH_Neck-E²MF.yaml')
    model.load('weights/FE-DETR.pt') # loading pretrain weights
    model.train(data='dataset/data_VisDrone.yaml',
                ...
                project='runs/train',
                name='VisDrone_C2f-FFF_AIFI-WLGH_Neck-E2MF',
                verbose=False
                )